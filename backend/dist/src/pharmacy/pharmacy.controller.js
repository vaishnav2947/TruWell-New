...
const pharmacy_search_dto_1 = require("./dto/pharmacy-search.dto");
let PharmacyController = class PharmacyController {
    constructor(pharmacyService) {
        this.pharmacyService = pharmacyService;
    }
    searchPharmacies(pharmacySearchDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [pharmacy_search_dto_1.PharmacySearchDto]),
    __metadata("design:returntype", void 0)
], PharmacyController.prototype, "searchPharmacies", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], PharmacyController.prototype, "getPharmacyById", null);
